...
| 7 | 웹 이식 (6보다 선행 결정) | 🔄 2026-07-03 — **원본 6개 스크린(01~06) 전부 완료**: Auth/온보딩/앱셸 · 03 리스트+사이드바 · 04 상세(8탭+우측바) · 01 인박스(체결 DB왕복) · 02 일지(노트 피드) · 05 전략편집기(읽기전용 4탭). **07 대시보드·16 인사이트·10 시나리오모니터 완료(2026-07-04)** — 07=`dashboard-view.tsx`(트리맵·헤드라인·액션큐)+openPlan `?tab=` 딥링크+plan sector. 16=`insights/insights-screen.tsx`(적중률·관점성과·건강도·승률손익비). 10=`scenarios/scenarios-screen.tsx`(전 플랜 시나리오 모니터+상태/종목/케이스 그룹+FilterPanel). 남은 것 = **11~13 스크리너·14 관심종목·15 리서치·17 보관함·18 휴지통·19~22 종목상세**(watchlist/screener/research는 종목상세 onOpenSecurity 선행 필요). ✅ source/core 재조정은 실측 no-op으로 종결(2026-07-04, 라인엔딩 차이뿐) |
