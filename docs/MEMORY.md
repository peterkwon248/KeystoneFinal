...
| 7 | 웹 이식 (6보다 선행 결정) | 🔄 2026-07-03 — Auth+온보딩+앱셸+03 리스트+사이드바 · **04 상세 8탭+우측 디테일바** · **01 인박스**(3-pane 트리아지, 체결 insert DB왕복) 완료. 남은 것 = 02 일지 → 05 전략편집기 → 06 청산 → 07 대시보드 등 새 스크린. ⚠️ 새 핸드오프 도입(screens 6→22)·source/core 재조정 미결 |
