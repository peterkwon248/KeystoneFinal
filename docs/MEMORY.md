...
| 7 | 웹 이식 (6보다 선행 결정) | 🔄 2026-07-03 — **원본 6개 스크린(01~06) 전부 완료**: Auth/온보딩/앱셸 · 03 리스트+사이드바 · 04 상세(8탭+우측바) · 01 인박스(체결 DB왕복) · 02 일지(노트 피드) · 05 전략편집기(읽기전용 4탭). 남은 것 = **새 핸드오프 확장분 07~22**(07 대시보드/스크리너/관심종목/리서치/인사이트/종목상세). ⚠️ 새 핸드오프 도입(screens 6→22)·source/core 재조정 미결 |
